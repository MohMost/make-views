...
function WhyUs() {
  ...
  return (
    <section
      id="whyus"
      className="w-full flex flex-col justify-center items-center py-4 gap-4 max-w-[90%] md:max-w-[70%] mx-auto md:my-10"
    >
      <div className="w-fit">
      ...
      <p className="text-center md:text-lg py-4 font-light">
